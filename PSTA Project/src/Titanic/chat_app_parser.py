        ...
        for name in program_name:
            ...
            if found:
                ...
                documentation_sections = [
                    {
                        ...
                        "title": "Program Overview",
                        "requirements": """ 
                        Provide information least (1-2 pages) about:
                    ...
                    },
                    {
                        ...
                        "title": "Program Architecture",
                        "requirements": """ 
                        Provide information at least (1-2 pages) about:
                    ...
                    },
                    {
                        ...
                        "title": "Program Structure",
                        "requirements": """
                        Provide information least (3-4 pages)  about:
                    ...
                    },
                    {
                        ...
                        "title": "Error Handling",
                        "requirements": """
                        Provide information least (2-3 pages) about:
                    ...
                    },
                    {
                        ...
                        "title": "Integration & Interfaces",
                        "requirements": """
                        Provide information least (-2 pages) about:
                ...
                for section in documentation_sections:
                    ...
                    # Clean up any markdown headings added by LLM to avoid duplicates
                ...
                # Format the documentation with proper markdown structure
                final_summary = format_documentation(name, section_content_dict)

                # Save the markdown version
                markdown_path = f'./output/final_summary_{name}.md'
                utils.save_as_markdown(final_summary, markdown_path)
                ...
                if result:
                    ...
                    print(f"PDF generation had issues. Check alternative formats in the output directory.")
